...
function defaultMove()
    ...
    mcontroller.setRotation(vec2.angle(world.distance(mcontroller.position(), {self.targetPos[1], mcontroller.yPosition() + 25})))
...
function move()
    ...
    self.gravity = self.lifeTimer * 0.016
    local decel = 0.95
    ...
    mcontroller.setVelocity({mcontroller.velocity()[1], self.gravity})
